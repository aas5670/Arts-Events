    ...
    <body>
                ...
                <div class="admin_cont">
                    ...
                    <div class="admin_content">
                        <div class="eventAddition">
                            <h2 class="eventConfirm">Event Addition Confirmation</h2>
                            <form id="eventPlaceholderForm" class="eventForm" action="addEvent.php">
                                <?php
                                ...
                                if(isset($_SESSION['confirmEventID']) && !empty($_SESSION['confirmEventID']))
                                {
                                    // Set the eventID to the session
                                    $eventID = $_SESSION['confirmEventID'];
                                }
                                else{
                                    session_destroy();
        ...
        AE_venue.venueID = AE_events.venueID and eventID = '$eventID'";
                                ...
                                if($queryResult === false) {
                                    ...
                                    <p class=\"head\">Event Specific Details</p>
                                    <div class=\"inputCont\">
                                ...
                                <fieldset class=\"eventOther\">
                                    ...
                                    <button accesskey=\"M\" id=\"addNewEvent\" class=\"eventSubmit\">Add another event</button>
                                </fieldset>\n";
                                    }
                                }
                                ?>
